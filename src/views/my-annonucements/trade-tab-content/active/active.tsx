...
import { TabNav, TabNavigation, TabNavigationLink } from "../../tab-block";
...
const TradeOffersPage = ({ deviceType }: any) => {
  const item = {
  ...
  return (
    <>
      <TabNavigation>
        <TabNavigationLink isActive>Активные</TabNavigationLink>
        <Link legacyBehavior href="/my-announcements/trade/trade-wait">
          <TabNavigationLink>Ожидающие</TabNavigationLink>
        </Link>
        <Link legacyBehavior href="/my-announcements/trade/dont-pay">
          <TabNavigationLink>Неоплаченные</TabNavigationLink>
        </Link>
